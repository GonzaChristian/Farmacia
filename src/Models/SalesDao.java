...
public class SalesDao {
    ...
    public boolean registerSaleDetailsQuery(int product_id, double sale_id, int
            sale_quantity, double sale_price, double sale_subtotal){
    ...
    public List listAllSalesQuery(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                sale.setSale_data(rs.getString("sale_date"));
                list_sales.add(sale);
            }
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, e.toString());
